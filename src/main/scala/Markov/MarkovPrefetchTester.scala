...
class MarkovPrefetchTester(dut: MarkovPrefetch)
...
object MarkovPrefetchTester extends App {
  
  chisel3.iotesters.Driver(() => new MarkovPrefetch(32, 32)) { dut =>
    new MarkovPrefetchTester(dut)
  }
}